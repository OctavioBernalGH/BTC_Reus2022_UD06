...
public class MainApp {
	...
	public static void main(String[] args) {
		 ...
		 * triangulo. Pediremos que figura queremos calcular, y según lo introducido los
		 * valores necesarios para su cálculo. Crea un método para cada figura. Este
	...
	public static String seleccionFigura() {
		String seleccion = JOptionPane
				.showInputDialog("Figura a calcular área, introduce: \nC = Circulo\nQ = Cuadrado \nT = Triangulo");
		return seleccion;
	}
