...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		/*
		 * Un número primo es un número natural que tiene solo dos divisores o factores: 1 y el mismo número. 
		...
		/*
		 * FLUJO DEL PROGRAMA
		 * 1. Crear un método que indique si un número obtenido por parámetro es primo o no.
		 * El número lo introduciremos por consola o por JOptionPane y se lo pasaremos por
		 * parámetro al método.
		 */
	...
	public static void detectorPrimos(int numeroPrimo) {
		...
		if(((numeroPrimo % 2 == 0) && (numeroPrimo != 2)) || (numeroPrimo % 3 == 0) && (numeroPrimo != 3) || (numeroPrimo == 1)) {
